...
function GN_posi = yinzitu7(posi_GPS_all,dis_measure,Xerr_gps_low)
...
for n=1:n_iters
 ...
 if max(abs(graph_1.parameters(1:3,1) - posi_iter_num(:,1))) < 0.001 && max(abs(graph_2.parameters(1:3,1) - posi_iter_num(:,2))) < 0.001 ...
                ...
                && max(abs(graph_7.parameters(1:3,1) - posi_iter_num(:,7))) < 0.001
            break
 else
            ...
            posi_iter_num(:,7)  = graph_7.parameters(1:3,1); 
