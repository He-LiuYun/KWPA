...
function GN_posi = yinzitu5(posi_GPS_all,dis_measure,Xerr_gps_low)
...
for n=1:n_iters
 ...
 if max(abs(graph_1.parameters(1:3,1) - posi_iter_num(:,1))) < 0.001 && max(abs(graph_2.parameters(1:3,1) - posi_iter_num(:,2))) < 0.001 ...
                ...
                && max(abs(graph_5.parameters(1:3,1) - posi_iter_num(:,5))) < 0.001
            break
 else
            ...
            posi_iter_num(:,4)  = graph_4.parameters(1:3,1); posi_iter_num(:,5)  = graph_5.parameters(1:3,1);
 end
